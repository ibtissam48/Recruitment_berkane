...
Route::middleware('auth')->prefix('account')->group(function () {
  ...
  Route::get('/des', 'AccountController@deactivateView')->name('account.desactivate');
  //Route::get('jobseeker', 'AccountController@jobseekerauth')->name('auth.jobseekeregister');
  ...
  Route::group(['middleware' => ['role:admin']], function () {
    ...
    //ville
   // Route::get('ville/{ville}/edit', 'App\Http\Controllers\CompanyVilleController@edit::class')->name('ville.edit');
    /*Route::post('ville', [CompanyVilleController::class, 'store'])->name('ville.store');
    Route::put('ville/{id}', [CompanyVilleController::class, 'update'])->name('ville.update');
    Route::delete('ville/{id}', [CompanyVilleController::class, 'destroy'])->name('ville.destroy');*/
 ...
 // Route::post('account/employer', [AccountController::class, 'checkEmployer'])->name('account.check');
});
Route::get('jobseeker', [AuthorController::class, 'jobseekerauth'])->name('jobseekeregister');

Route::get('customer', [CustomersController::class, 'create'])->name('auth.register');
