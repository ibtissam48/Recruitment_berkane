          ...
          <div class="col-xl-4 col-sm-6 py-2">
              <div class="card dashboard-card text-white h-100 shadow">
                  <div class="card-body primary-bg">
                      ...
                      <h6 class="text-uppercase">Jobseekers</h6>
          ...
          <div class="col-xl-4 col-sm-6 py-2">
              <div class="card dashboard-card text-white h-100 shadow">
                  <div class="card-body bg-info">
                      ...
                      <h6 class="text-uppercase">Recruiters</h6>
      ...
      <section class="dashboard-authors my-5">
        <div class="row my-4">
          <div class="col-lg-12 col-md-8 col-sm-12">
            <h4 class="card-title text-secondary">Manage Recruiters  </h4>
            ...
            <button class="btn primary-outline-btn disabled">Total Number of recruiters registered ({{ $recentAuthors->total()}}) </button>
