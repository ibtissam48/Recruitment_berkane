  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">RECRUITEMENT</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Berkane,Berkane</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-phone"></i> +212-00000</a>
             <a href="tel:98400001511" class="footer-links"><i class="fas fa-mobile"></i> +212-00000</a>
             <a href="mailto:info@joblister.com" class="footer-links"><i class="fas fa-envelope"></i> info@recruitement.com</a>
